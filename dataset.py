...
class KWSDataModule(LightningDataModule):
    def __init__(self, path, batch_size=128, num_workers=0, n_fft=512, patch_num = 4, 
    ...
    def collate_fn(self, batch):
        ...
        for sample in batch:
            ...
            mels.append(ToTensor()(librosa.amplitude_to_db(self.transform(waveform).squeeze().numpy(), ref=np.max, amin=1e-05, top_db=80.0)))
        ...
        mels = rearrange(mels, 'b c h (p1 w) -> b p1 (c h w)', p1=self.patch_num)
