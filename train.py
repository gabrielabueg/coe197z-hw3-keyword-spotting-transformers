...
if __name__ == "__main__":
  ...
  # make a dictionary from CLASSES to integers
    ...
    datamodule = KWSDataModule(batch_size=args.batch_size, num_workers=args.num_workers, path=args.path, 
        		n_fft=args.n_fft, patch_num = args.patch_num, n_mels=args.n_mels, 
    ...
    model_path = os.path.join(args.path, "checkpoints", "transformer-kws-best-acc.pt")
